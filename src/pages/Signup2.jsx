...
const Signup = () => {
  ...
  const executeRecaptcha = () => {
    const recaptchaSiteKey = process.env.REACT_APP_RECAPTCHA_SITE_KEY || '6LfkvD4rAAAAAPJPSvnKaHCvLej0hRotvj3TOYmA';
  ...
  const sendVerificationEmail = async () => {
    try {
      ...
      const response = await fetch('http://localhost:8000/account/email/email_verification/', {
        method: 'POST',
        headers: {
  ...
  const verifyAndRegister = async () => {
    try {
      ...
      const verifyResponse = await fetch('http://localhost:8000/account/email/verify_code/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      const registerResponse = await fetch('http://localhost:8000/account/register/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const checkUsernameAvailability = async (username) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/account/check_username/${username}/`, {
        method: 'GET',
        credentials: 'include'
      });
  ...
  const checkEmailAvailability = async (email) => {
    ...
    try {
      ...
      const response = await fetch(`http://localhost:8000/account/check_email/`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleGoogleSignup = async (response) => {
    try {
      ...
      const backendResponse = await fetch('http://localhost:8000/account/login/google_login/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
