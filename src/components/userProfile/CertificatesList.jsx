...
const CertificatesList = ({ notifications, t }) => {
  // استخراج گواهینامه‌ها از اعلان‌ها
  const certificates = notifications
    .slice() // جلوگیری از تغییر آرایه اصلی
    .reverse() // برای اینکه جدیدترین پایین‌تر نمایش داده نشه (می‌تونی حذفش کنی)
    .map((notif) => {
      // پیدا کردن لینک از متن
